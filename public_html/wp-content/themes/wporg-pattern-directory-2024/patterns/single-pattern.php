...
<!-- wp:group {"style":{"spacing":{"padding":{"bottom":"var:preset|spacing|50"},"margin":{"top":"0"}}},"layout":{"type":"default"},"align":"wide"} -->
<div class="wp-block-group alignwide" style="margin-top:0;padding-bottom:var(--wp--preset--spacing--50)">
